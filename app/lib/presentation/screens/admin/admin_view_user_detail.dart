...
class _AdminViewUserDetailScreenState extends State<AdminViewUserDetailScreen> {
  ...
  Future<void> _load() async {
    ...
    final result = await sl<GetUserByIdUseCase>()(widget.userId);
  ...
  Future<void> _save() async {
    try {
      final result = await sl<UpdateUserStatusUseCase>()(
  ...
  Widget _buildHeaderCard(
    ...
    final title = _user?.displayName ?? '';
    final phone = _user?.phone ?? '';
    final avatarUrl = _user?.avatarUrl ?? '';
    final roleName = _user?.role?.name ?? 'customer';
  ...
  Widget _buildInfoCard(
    ...
    final shopName = _user?.shopName ?? '';
    final createdAt = _user?.formattedCreatedAt ?? '';
