  ...
  Future<Either<Failure, Unit>> call({
    ...
    switch (type) {
      case CategoryType.tireBrand:
        return tireBrandRepository.create(category as Brand);

      case CategoryType.vehicleMake:
        return vehicleMakeRepository.create(category as VehicleMake);

      case CategoryType.tireSpec:
        return tireSpecRepository.create(category as TireSpec);
    }
  }
}