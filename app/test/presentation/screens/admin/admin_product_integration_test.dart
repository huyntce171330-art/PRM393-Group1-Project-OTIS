...
void main() {
  ...
  Widget createListScreenUnderTest() {
    return BlocProvider<AdminProductBloc>.value(
      value: mockBloc,
      child: MaterialApp(
        home: const AdminProductListScreen(),
      ),
    );
  }
  ...
  Widget createDetailScreenUnderTest({required String productId}) {
    return BlocProvider<AdminProductBloc>.value(
      value: mockBloc,
      child: MaterialApp(
        home: AdminProductDetailScreen(productId: productId),
      ),
    );
  }
  ...
  group('AdminProductListScreen', () {
    testWidgets(
      'renders Inventory title and search bar',
      (WidgetTester tester) async {
        // Arrange
        whenListen(
          mockBloc,
          Stream.value(const AdminProductState.loading()),
    ...
    testWidgets(
      'displays loading skeleton when state is loading',
      (WidgetTester tester) async {
        // Arrange
        whenListen(
          mockBloc,
    ...
    testWidgets(
      'displays product list when state is loaded',
      (WidgetTester tester) async {
        // Arrange
        final loadedState = AdminProductState.loaded(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        // Arrange
        final emptyState = AdminProductState.loaded(
          products: [],
          filter: const AdminProductFilter(),
          selectedBrand: null,
          stockStatus: StockStatus.all,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        // Arrange
        const errorState = AdminProductState.error(
    ...
    testWidgets(
      'triggers GetAdminProductsEvent on init',
      (WidgetTester tester) async {
        // Arrange
        when(() => mockBloc.state)
        ...
        verify(() => mockBloc.add(
              const GetAdminProductsEvent(filter: null),
            )).called(1);
      },
    );

    testWidgets(
      'displays brand filter chips',
      (WidgetTester tester) async {
        // Arrange
        final loadedState = AdminProductState.loaded(
          products: [tProduct1],
    ...
    testWidgets(
      'displays low stock filter chip',
      (WidgetTester tester) async {
        // Arrange
        final loadedState = AdminProductState.loaded(
          products: [],
    ...
    testWidgets(
      'shows FAB button for adding products',
      (WidgetTester tester) async {
        // Arrange
        whenListen(
          mockBloc,
    ...
    testWidgets(
      'filtering by brand selects the correct chip',
      (WidgetTester tester) async {
        // Arrange
        final loadedStateWithBrand = AdminProductState.loaded(
          products: [tProduct1],
    ...
    testWidgets(
      'filtering by All brands shows all products',
      (WidgetTester tester) async {
        // Arrange
        final allProductsState = AdminProductState.loaded(
          products: [tProduct1, tProduct2],
          filter: const AdminProductFilter(),
          selectedBrand: null,
          stockStatus: StockStatus.all,
  ...
  group('AdminProductDetailScreen', () {
    ...
    testWidgets(
      'renders product details correctly when loaded',
      (WidgetTester tester) async {
        // Arrange
        ...
        // Act
        await tester.pumpWidget(createDetailScreenUnderTest(productId: testProductId));
        await tester.pump();
    ...
    testWidgets(
      'displays stock status badge correctly for in stock',
      (WidgetTester tester) async {
        // Arrange
        final detailLoadedState = AdminProductState.detailLoaded(
          product: tProduct1,
    ...
    testWidgets(
      'displays out of stock badge when stock is 0',
      (WidgetTester tester) async {
        ...
        final detailLoadedState =
            AdminProductState.detailLoaded(product: outOfStockProduct);
        whenListen(
          mockBloc,
          Stream.value(detailLoadedState),
          initialState: const AdminProductState.initial(),
        ...
        // Act
        await tester.pumpWidget(createDetailScreenUnderTest(productId: 'prod-003'));
        await tester.pump();
    ...
    testWidgets(
      'displays low stock badge when stock <= 10',
      (WidgetTester tester) async {
        ...
        final detailLoadedState =
            AdminProductState.detailLoaded(product: lowStockProduct);
        whenListen(
          mockBloc,
          Stream.value(detailLoadedState),
          initialState: const AdminProductState.initial(),
        ...
        // Act
        await tester.pumpWidget(createDetailScreenUnderTest(productId: 'prod-004'));
        await tester.pump();
    ...
    testWidgets(
      'shows loading indicator when detailLoading',
      (WidgetTester tester) async {
        // Arrange
        whenListen(
          mockBloc,
          Stream.value(const AdminProductState.detailLoading()),
          initialState: const AdminProductState.initial(),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        // Arrange
        const errorState =
            AdminProductState.error(message: 'Product not found');
        whenListen(
          mockBloc,
          Stream.value(errorState),
          initialState: const AdminProductState.initial(),
    ...
    testWidgets(
      'triggers GetProductDetailEvent on init',
      (WidgetTester tester) async {
        // Arrange
        when(() => mockBloc.state)
            .thenReturn(const AdminProductState.initial());
        ...
        verify(() => mockBloc.add(
              GetProductDetailEvent(productId: testProductId),
            )).called(1);
      },
    );

    testWidgets(
      'shows Edit Product button',
      (WidgetTester tester) async {
        // Arrange
        final detailLoadedState = AdminProductState.detailLoaded(
          product: tProduct1,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final detailLoadedState =
            AdminProductState.detailLoaded(product: tireProduct);
        whenListen(
          mockBloc,
          Stream.value(detailLoadedState),
          initialState: const AdminProductState.initial(),
        ...
        // Act
        await tester.pumpWidget(createDetailScreenUnderTest(productId: 'prod-005'));
        await tester.pump();
